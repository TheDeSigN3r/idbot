...
----config----
local bot_api_key = "208182902:AAFBBfAH_sXEwNeQ-wA1M7RmN9T3JeiBEDY" --BOT TOKEN تو کن ربات خود را در اینجا قرار دهید
local You = 87946267  --ID ADMIN ایدی خود را اینجا قرار دهید
